...
namespace Sitecore.Foundation.Fields.Fields.ColorPicker
{
  public class ColorPickerField : Shell.Applications.ContentEditor.Text, IContentField
  {
    ...
    protected void SetColorAdvanced(ClientPipelineArgs args)
    {
      ...
      {
        var url = new UrlString("/sitecore/shell/~/xamlSitecore.Foundation.Fields.ColorPicker.ColorPickerDialog.aspx");
